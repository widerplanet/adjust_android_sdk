...
public class ActivityStateV401 implements Serializable, Cloneable {
    ...
    @Override
    public ActivityStateV490 clone() {
        try {
            return (ActivityStateV490) super.clone();
    ...
    public boolean equals(Object other) {
        ...
        ActivityStateV490 otherActivityState = (ActivityStateV490) other;
